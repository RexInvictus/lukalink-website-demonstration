...
export const metadata = {
  title: "Best E-commerce Developers | Lukalink Web Development",
  description: "At Lukalink we develop high-grade, scalable, full-stack e-commerce solutions for your business needs.",
};
    ...
    <div className="bg-flipped bg-cover text-plex-sans">
      ...
      <div className="w-1/2 max-md:w-4/5 z-10 2xl:w-1/2 md:w-3/4 max-breakpoint:w-full mt-20 m-auto py-10">
        ...
        <h1 className="text-7xl font-bold -ml-1 mt-1 tracking-tighter">
          E-Commerce <span className="text-blue-ll">Solutions</span>
        </h1>
      </div>
        ...
        <div className="w-1/2 max-md:w-4/5 z-10 2xl:w-1/2 md:w-3/4 m-auto pt-2">
          <section className="py-10">
            ...
            <p className="mb-5 text-2xl">
              ...
              implementing product management systems, we handle all the
              technical details so you can focus on growing your business.
            </p>
            ...
            <p className="mb-5 text-2xl">
              ...
              your target audience, and any specific functionalities you
              require.
            </p>
            <p className="mb-5 text-2xl">
      ...
      <div className="flex flex-col items-center py-10 justify-center w-1/2 max-md:w-4/5 z-10 2xl:w-1/2 md:w-3/4 m-auto">
        <div className="w-3/4">
          <h1 className="text-lefttext-6xl text-blue-ll font-bold -ml-1 mt-1 tracking-tighter">
            Contact Us
          </h1>
        </div>
        <ContactForm />
